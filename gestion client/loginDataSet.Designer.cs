...
namespace WindowsFormsApp12 {
    ...
    public partial class loginDataSet : global::System.Data.DataSet {
        ...
        public partial class clientDataTable : global::System.Data.TypedTableBase<clientRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public clientRow AddclientRow(int id, string nom, string prenom, string datenaissance) {
        ...
        public partial class clientRow : global::System.Data.DataRow {
            ...
            public string datenaissance {
                get {
                    try {
                        return ((string)(this[this.tableclient.datenaissanceColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace WindowsFormsApp12.loginDataSetTableAdapters {
    ...
    public partial class clientTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[client] WHERE (([id] = @Original_id) AND ((@IsNull_nom = 1 AND [nom] IS NULL) OR ([nom] = @Original_nom)) AND ((@IsNull_prenom = 1 AND [prenom] IS NULL) OR ([prenom] = @Original_prenom)) AND ((@IsNull_datenaissance = 1 AND [datenaissance] IS NULL) OR ([datenaissance] = @Original_datenaissance)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[client] ([id], [nom], [prenom], [datenaissance]) VALUES (@id, " +
                "@nom, @prenom, @datenaissance);\r\nSELECT id, nom, prenom, datenaissance FROM clie" +
                "nt WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[client] SET [id] = @id, [nom] = @nom, [prenom] = @prenom, [datenaissance] = @datenaissance WHERE (([id] = @Original_id) AND ((@IsNull_nom = 1 AND [nom] IS NULL) OR ([nom] = @Original_nom)) AND ((@IsNull_prenom = 1 AND [prenom] IS NULL) OR ([prenom] = @Original_prenom)) AND ((@IsNull_datenaissance = 1 AND [datenaissance] IS NULL) OR ([datenaissance] = @Original_datenaissance)));
SELECT id, nom, prenom, datenaissance FROM client WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApp12.Properties.Settings.Default.loginConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, nom, prenom, datenaissance FROM dbo.client";
        ...
        public virtual int Delete(int Original_id, string Original_nom, string Original_prenom, string Original_datenaissance) {
            ...
            if ((Original_datenaissance == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[6].Value = ((string)(Original_datenaissance));
            }
        ...
        public virtual int Insert(int id, string nom, string prenom, string datenaissance) {
        ...
        public virtual int Update(int id, string nom, string prenom, string datenaissance, int Original_id, string Original_nom, string Original_prenom, string Original_datenaissance) {
            ...
            if ((Original_datenaissance == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(Original_datenaissance));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nom, string prenom, string datenaissance, int Original_id, string Original_nom, string Original_prenom, string Original_datenaissance) {
            return this.Update(Original_id, nom, prenom, datenaissance, Original_id, Original_nom, Original_prenom, Original_datenaissance);
        }
    }
